...
public class FavoritesFragment extends Fragment implements FavoriteJobsAdapter.OnFavoriteClickListener {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        // Khởi tạo danh sách công việc yêu thích và API
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        btnExploreNow.setOnClickListener(v -> {
            Toast.makeText(getContext(), "Chuyển đến màn hình khám phá công việc", Toast.LENGTH_SHORT).show();
        });
            ...
            public void onResponse(@NonNull Call<SavedJobsApiResponse> call, @NonNull Response<SavedJobsApiResponse> response) {
                if (getActivity() != null && isAdded()) {
                    if (response.isSuccessful() && response.body() != null && response.body().isSuccess()) {
                        Log.d(TAG, "Đã tải công việc yêu thích");
    ...
    public void onUnfavoriteClick(Job job, int position) {
        ...
        new AlertDialog.Builder(getContext())
                ...
                .setPositiveButton("Đồng ý", (dialog, which) -> {
                    ...
                    Toast.makeText(getContext(), "Đã bỏ yêu thích (API chưa tích hợp)", Toast.LENGTH_SHORT).show();
                    if (adapter != null) {
